function WorkHighlightCard({ heading_one, heading_two, heading_three }) {
  return (
    <div className="w-64 flex flex-col items-start p-5 m-2 border-2 border-opacity-50 border-white rounded-lg hover:border-opacity-75 transition ease-in-out duration-300">
